        ...
        <div class="cart-content">
            <div class="cart-items">
                ...
                <div class="cart-item" data-id="{{ $item['id'] }}">
                    <div class="product-image-wrapper-cart">
                        <div class="w-full h-56 rounded-xl flex items-center justify-center overflow-hidden">
                            <img class="max-h-full max-w-full object-contain" src="{{ $item['image'] }}"
                                alt="{{ $item['name'] }}">
                    ...
                    <div class="item-details">
                        ...
                        <div class="qty-controls">
                            ...
                            <input class="qty-input" type="number" min="1" value="{{ $item['quantity'] }}"
                                data-id="{{ $item['id'] }}" data-qty-input>
        ...
        <div class="modal-content">
            ...
            <form id="checkoutForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="customer_address" name="address" required rows="3"
                ...
                <div class="form-group">
                    ...
                    <textarea id="customer_notes" name="notes" rows="2"
