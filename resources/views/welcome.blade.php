   ...
   <x-layout/>
    ...
    <div class="hero-content">
     <h1 class="hero-title">
        Descubre la Excelencia<br>
        <span class="hero-accent">en Cada Botella</span>
      </h1>
      <p class="hero-subtitle">
        Llevamos el sabor de la celebración hasta tu mesa, para que cada momento con familia y amigos sea inolvidable
      </p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="features-grid">
        <div class="feature-card">
          ...
          <p class="feature-text">Entrega rápida y segura a todo el país con tracking en tiempo real</p>
        </div>
        ...
        <div class="feature-card">
          ...
          <p class="feature-text">Garantizamos los mejores precios del mercado en productos premium</p>
        </div>
